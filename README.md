...
└── src/
    └── js/
        ...
        └── hardware/
            ...
            ├── handy.js        # The Handy Wi-Fi API driver (HAMP mode, /slide travel range with the end-stop margin, verified replies, confirmed stop, offline and device-side-stop detection)
            ├── handy.test.js
            ├── handy-protocol.js     # Pure Handy API v2 helpers: reply classification, velocity clamp, slide-range normalisation, end-stop margin, HAMP state and slide-result reading, battery parsing
