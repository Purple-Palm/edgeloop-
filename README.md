...
* **At the ceiling: Full Stop vs Crawl.** What the strokers do once your pulse crosses the pullback trigger. *Full Stop* parks the primary at 0%; *Crawl* keeps a 10% micro-motion so the edge stays alive. It applies in every mode, including an Edge Training hold and every Oracle state reached while on the mark. Force Orgasm overrides both.
